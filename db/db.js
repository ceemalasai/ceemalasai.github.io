export default {
    bio: {
        about: {
            text: [
                "Hi 👋 I'm Sai Kishore.",
                "I am an Automation Engineer / SDET specializing in building robust test frameworks and backend solutions. Expert in Playwright and Selenium with a strong foundation in ECE and Python development.",
                "🚀 What I Do: Expert in Java-based Selenium and Playwright frameworks; Python & Flask enthusiast building real-time web applications; Power user of Linux (Ubuntu/Debian) for system administration.",
            ],
        },
        contact: {
            text: [
                "Email: ceemalasai143@gmail.com",
                "Linkedin: https://www.linkedin.com/in/saikishore-ceemala/",
            ],
        },
    },
    skills: [
